...
def two_fr_setters(fr_Setters):
	...
	#print "STICKY SETTER SPOT"
	#print sticky_setter_spot
	...
	if sticky_setter_spot == 1:
		...
		#### lets find out where the player that needs to move (6 spot) currently is

		for player_info in sorted_rotation_list:
			if player_info[1] == 4:
				player_info[1] = moving_setter_spot
	...
	if sticky_setter_spot == 2:
		...
		#### lets find out where the player that needs to move (5 spot) currently is
...
#print sorted_final_rotation



sorted_rotation_list_html = []

for x in sorted_final_rotation:
	sorted_rotation_list_html.append(list(x))
#print sorted_rotation_list_html

#print sorted_rotation_list_html[0]
#print sorted_rotation_list_html[1][0]
#print names[0]
# ### 4 spot / 0 spot
...
final_FR_lineup = [sorted_rotation_list_html[0][0],sorted_rotation_list_html[1][0],sorted_rotation_list_html[2][0]]
final_BR_lineup = [sorted_rotation_list_html[3][0],sorted_rotation_list_html[4][0],sorted_rotation_list_html[5][0]]


final_FR_lineup_names = [names[final_FR_lineup[0]-1],names[final_FR_lineup[1]-1],names[final_FR_lineup[2]-1]]
final_BR_lineup_names = [names[final_BR_lineup[0]-1],names[final_BR_lineup[1]-1],names[final_BR_lineup[2]-1]]
...
print "--------------------------"
print "<br>"
print final_FR_lineup_names[0]
print final_FR_lineup_names[1]
print final_FR_lineup_names[2]
print "<br>"
print final_BR_lineup_names[0]
print final_BR_lineup_names[1]
print final_BR_lineup_names[2]
