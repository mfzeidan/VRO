...
<form method="post" action="first_release_v1.php">
...
<div class="col-xs-3">
    ...
    <div class="input-group">
      <span class="input-group-addon">
        <input type="radio" name="chk_box" id="chk_box" value="1">
      </span>
...
//$command = escapeshellcmd('/var/www/html/VRO/json_testing/IP/release_v1.py ');
...
$result = shell_exec('python /var/www/html/VRO/json_testing/IP/release_v1.py ' . escapeshellarg(json_encode($arr)));
