...
def two_BR_setters(which_setter,sticky_setter):
	...
	dont_move_setter = full_initial_rotation_names.index(sticky_setter)
	...
	if dont_move_setter == 5:
		...
		print which_setter
		print "is this working"
		where_is_moving_setter = full_initial_rotation_names[full_initial_rotation_names.index(which_setter)]
		print where_is_moving_setter
		#now find the player that you gotta move
		
		player_to_switch = full_initial_rotation_names[2]
		print player_to_switch


		a, b = full_initial_rotation_names.index(which_setter), full_initial_rotation_names.index(player_to_switch)

		full_initial_rotation_names[b], full_initial_rotation_names[a] = full_initial_rotation_names[a], full_initial_rotation_names[b]
		print "NEW ROTATION"
		print display_final_rotation(full_initial_rotation_names)

	if dont_move_setter == 4:
		# if the sticky setter is in 5, lets swap the other setter with the player in the 0 spot in the list index
		print "sticky in 4 spot"
		print "this is the setter that moves"
		#lets find where this setter is in the starting lineup
		print which_setter
		...
		player_to_switch =full_initial_rotation_names[1]
		print player_to_switch
...
def display_final_rotation(final_rotation):
	...
	print "----------------"
	print "<br>"
	print final_rotation[0]


	print final_rotation[1]


	print final_rotation[2]
	...
	print "<br>"
	print "<center><h1>"
	print final_rotation[3]


	print final_rotation[4]


	print final_rotation[5]
