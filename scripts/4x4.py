...
idx = [1, 2,3,4]
d3 = {'A-Player': pd.Series(['Player1','Player2','Player3','Player4'], index=idx),
     'FR': pd.Series([FR_x1,FR_x2,FR_x3,FR_x4], index=idx),
     'BR': pd.Series([BR_x1,BR_x2,BR_x3,BR_x4], index=idx),
}
...
idx = [1,2,3,4]
d2 = {'A-Player': pd.Series(['Player1', 'Player2','Player3','Player4'], index=idx),
     'FR': pd.Series([2,3,7,7], index=idx),
     'BR': pd.Series([7,7,3,4], index=idx)}
...
vball_model += FR_x1 + FR_x2 + FR_x3 + FR_x4 == 2
vball_model += BR_x1 + BR_x2+ BR_x3+ BR_x4 == 2
